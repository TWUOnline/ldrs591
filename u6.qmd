...
Plano Clark and Creswell (2010) remind us that we read research "to learn new knowledge about topics, to become informed on policy debates, and to find suggestions for improving your practice" (p. 15). Throughout this course, you have learned how to engage with research in ways that reflect these goals.
...
This unit is divided into three topics. See the [**Unit 6 Topics**](https://learn.twu.ca/mod/book/view.php?id=1171452){target="_blank"} link at the bottom of this page for the course notes on these topics.

<!-- !!!
The Moodle link above needs to be replaced.

[**Unit 6 Topics**](https://learn.twu.ca/mod/book/view.php?id=1171452)
-->
...
1. Reflecting on your Scholarly Inquiry Journey
2. Drafting Your Letter of Intent
...
### Activity: Learning Activity: Reflecting on your Scholarly Inquiry Journey
...
#### Step 2: Connect Your Research to Leadership Practice {.unnumbered}
...
#### Step 3: Identify Your Future Goals {.unnumbered}
...
#### Step 4: Outline Your Letter of Intent {.unnumbered}
...
**Remember to always include in-text citations following APA 7.**
