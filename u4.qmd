...
Unit 4 is divided into four topics. See the [**Unit 4 Topics**](https://learn.twu.ca/mod/book/view.php?id=1176252){target="_blank"} link at the bottom of this page for the course notes on the following topics:

<!-- !!!
The Moodle link above needs to be replaced.

[**Unit 4 Topics**](https://learn.twu.ca/mod/book/view.php?id=1176252)
-->
...
- Read Chapters 5 and 8 in *Doing a Systematic Review: A Student’s Guide* (Cherry et al., 2024).
...
- Assessment: Contribute to the Course Discussions. See [Assessment tab](https://learn.twu.ca/course/view.php?id=33799&section=8#tabs-tree-start){target="_blank"} in Moodle for details.

<!-- !!!
The Moodle link above needs to be replaced.

[Assessment tab](https://learn.twu.ca/course/view.php?id=33799&section=8#tabs-tree-start)
-->
...
- Video tutorials found at: [https://libguides.twu.ca/library_research/all_video_tutorials](https://libguides.twu.ca/library_research/all_video_tutorials){target="_blank"}
...
You may use this table throughout your literature search process. It will be a helpful reference when writing your assignment and can also be included as an appendix if your instructor requires evidence of your search strategy. [Click here for a literature search table template](file:///C:\Users\jodi.mcbride\OneDrive%20-%20Trinity%20Western%20University\Documents\591%20Curriculum%20Revision\New%20Units\Literature%20Search%20Tracking%20Template.docx){target="_blank"}.

You can also manage your references using an online reference manager that will help you collect, organize, cite, and share your references according to the referencing style you will be using. There are several free, online reference managers available such as [Zotero](https://www.zotero.org/){target="_blank"}, [RefWorks](https://www.refworks.com/refworks2/help/Welcome.htm){target="_blank"} and [EndNote](http://endnote.com/){target="_blank"}. TWU library has a research guide that describes [how to use EndNote](http://libguides.twu.ca/EndNote/){target="_blank"}. The library guide will help you sign up for a free EndNote account and will teach you to use EndNote to download and store your citations in folders, input citations into Word documents, and create reference lists.
...
- **Bias and special interests**: According to Cherry et al. (2024), bias occurs in many forms, including language bias and publication bias. For example, "language bias occurs because studies that report positive findings are mostly likely to be published in English-language journals" (Cherry, et al., 2024, p. 53) and studies reporting negative or null findings are most likely to be published in non-English language journals. Publication bias occurs when studies reporting positive findings are more likely published in peer-reviewed academic journals. See Chapter 3 in *Doing a Systematic Review: A Student’s Guide* (Cherry et al., 2024) for more detail.

### Activity: Learning Activity

📺 **Watch** "How to Evaluate Sources" from the [Stanford University Libraries](https://www.youtube.com/watch?v=bZ122WakNDY){target="_blank"} (2017) to learn more about how to evaluate your sources.

![https://img.youtube.com/vi/bZ122WakNDY/maxresdefault.jpg](assets/u4/image1.jpeg)

📖 **Read** Chapter 8: "Quality Assessment: Where Do I Begin?" in *Doing a Systematic Review: A Student’s Guide* (Cherry et al., 2024).

📺 **Watch** the following videos:

- "Assessing Online Resources" from the [TWU Library](https://www.twu.ca/academics/library){target="_blank"} "Evaluating a Journal Article" from the [JCU Library](https://www.youtube.com/@jculibrary1){target="_blank"} (2017)

> ![https://img.youtube.com/vi/z6dOGkpI6H4/maxresdefault.jpg](assets/u4/image2.jpeg)
