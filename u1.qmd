...
Unit 1 is divided into four topics. See the [**Unit 1 Topics**](https://learn.twu.ca/mod/book/view.php?id=1171448){target="_blank"} link at the bottom of this page for the course notes on the following topics:

<!-- !!!
The Moodle link above needs to be replaced.

[**Unit 1 Topics**](https://learn.twu.ca/mod/book/view.php?id=1171448)
-->
...
1. Read Chapters 1 and 2 in *Introduction to Research in Leadership* (Rosch et al., 2023).
2. Reflective Journalling activities.
...
### E-Resources {.unnumbered}

The following articles can be found through the [TWU library](https://www.twu.ca/academics/library){target="_blank"}:
...
📺 **Watch** the following video "Research as Inquiry" from [Bertrand Library at Bucknell University](https://www.youtube.com/@BertrandLibrary){target="_blank"} [-@bertrandlibraryatbucknelluniversityResearchInquiry2023] that gives an overview of research as inquiry:

![https://img.youtube.com/vi/ufAJV76HW6g/0.jpg](assets/u1/image1.jpeg)
...
# Leadership and Scholarly Inquiry {.unnumbered}
...
📺 **Watch** the following video "Introduction to Research Design" from [Research & Doctoral Services at Walden University](https://www.youtube.com/@researchdoctoralse4565){target="_blank"} [-@waldenuniversityIntroductionResearchDesign2015] where Dr. Patton introduces the concept of research as a scholar-practitioner:

![https://img.youtube.com/vi/GYywR7SA03E/maxresdefault.jpg](assets/u1/image2.jpeg)
...
📺 **Watch** the following short video "What’s Your Worldview? (Quiz)" by the [Impact 360 Institute](https://www.youtube.com/@Impact360instituteOrg){target="_blank"} [-@impact360instituteWhatsYourWorldview2014] that explains the concept of worldview:

![https://img.youtube.com/vi/VXnSE0uvwzM/maxresdefault.jpg](assets/u1/image3.jpeg)
...
Figure 1. Research Paradigms [@brownMedicalScienceEducators2020]

![](assets/u1/image4.gif)

**Source**: [https://link.springer.com/article/10.1007/s40670-019-00898-9](https://link.springer.com/article/10.1007/s40670-019-00898-9){target="_blank"}

📺 **Watch** the following helpful video "Ontology, Epistemology, Methodology and Methods in Research Simplified!" by [Laura Killam](https://www.youtube.com/@NurseKillam){target="_blank"} [-@nursekillamOntologyEpistemologyMethodology2015] that explains Paradigms, Ontology and Epistemology:

![https://img.youtube.com/vi/hCOsY5rkRs8/maxresdefault.jpg](assets/u1/image5.jpeg)
...
📺 **Watch** the following video where [Gary Gramenz](https://www.youtube.com/@garygramenz){target="_blank"} [-@gramenzPhilosophicalFoundationsResearch2013] explains "Philosophical Foundations for Research Methodology":

![https://img.youtube.com/vi/j758XBXD4r4/maxresdefault.jpg](assets/u1/image6.jpeg)
