...
- Brown, M. E., & Dueñas, A. N. (2020). A medical science educator’s guide to selecting a research paradigm: Building a basis for better research. *Medical Science Educator, 30*, 545–53. [https://doi.org/10.1007/s40670-019-00898-9](https://doi.org/10.1007/s40670-019-00898-9){target="_blank"}
...
According to Plano-Clark and Creswell (2015), "research is a process of steps used to collect and analyze information in order to increase our knowledge about a topic or an issue" (p.4) and it is different than informal research.

📺 **Watch** the following video "Research as Inquiry" from [Bertrand Library at Bucknell University](https://www.youtube.com/@BertrandLibrary){target="_blank"} (2024) that gives an overview of research as inquiry:
...
In the section titled "Application," Nibert (2011) notes that the scholarship of application:
...
📺 **Watch** the following video "Introduction to Research Design" from [Research & Doctoral Services at Walden University](https://www.youtube.com/@researchdoctoralse4565){target="_blank"} (2015) where Dr. Patton introduces the concept of research as a scholar-practitioner:
...
📺 **Watch** the following short video "What’s Your Worldview? (Quiz)" by the [Impact 360 Institute](https://www.youtube.com/@Impact360instituteOrg){target="_blank"} (2015) that explains the concept of worldview:
...
📺 **Watch** the following helpful video "Ontology, Epistemology, Methodology and Methods in Research Simplified!" by [Laura Killam](https://www.youtube.com/@NurseKillam){target="_blank"} (2015) that explains Paradigms, Ontology and Epistemology:
...
📺 **Watch** the following video where [Gary Gramenz](https://www.youtube.com/@garygramenz){target="_blank"} (2014) explains "Philosophical Foundations for Research Methodology":

![https://img.youtube.com/vi/j758XBXD4r4/maxresdefault.jpg](assets/u1/image6.jpeg)

📖 **Read** "[Servant Leadership: A Worldview Perspective](https://www.regent.edu/acad/global/publications/ijls/new/vol2iss2/Wallace/WallaceV2Is2.pdf){target="_blank"}" (Wallace, 2007).

📖 **Read** "[A Medical Science Educator’s Guide to Selecting a Research Paradigm: Building a Basis for Better Research](https://www.researchgate.net/publication/338202096_A_Medical_Science_Educator%27s_Guide_to_Selecting_a_Research_Paradigm_Building_a_Basis_for_Better_Research){target="_blank"}" (Brown & Dueñas, 2020).
